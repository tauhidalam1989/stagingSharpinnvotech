...
export default function ProductCategoriesPage({ params }: { params: Promise<{ lang: string }> }) {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl font-black text-zinc-900 dark:text-white tracking-tight">Product Categories</h1>
                    <p className="text-xs text-zinc-500 font-medium">Manage how your products are grouped.</p>
                </div>
                {!showForm && (
                    <button 
